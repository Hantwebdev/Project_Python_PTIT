...
npaClassifications = npaClassifications.reshape(
    (npaClassifications.size, 1))  # định hình lại mảng numpy thành 1d, cần phải chuyển để gọi đến đào tạo
...
###### Vẽ đường viền và lọc ra biển số xe #############
...
if detected == 1:
    ...
    for screenCnt in screenCnt:
        ...
        ##########Cắt biển số xe và căn chỉnh nó cho đúng góc################
